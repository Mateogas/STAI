...
def ask_aisha(service: AishaService) -> None:
    ...
    try:
        ...
        announce("The handbook check could not be completed.")
        st.error(
            "AISHA couldn't complete this handbook check. Your question was not shared. "
            "Reload the assistant and try again."
        )
