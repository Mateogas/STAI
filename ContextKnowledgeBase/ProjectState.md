...
- A normalized SQLite epoch for Alyssa's confirmed profile, ordered policy conversations, claim/citation metadata, cases, attribute revisions, Validation Results, retry/idempotency state, holiday cache, retrieval pointer, and safe reset.
